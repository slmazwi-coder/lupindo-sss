...
const DEFAULT_NEWS = [
  {
    ...
    date: '2026-05-01',
    excerpt: 'Applications for general admission and boarding for the 2027 academic year are open. Submit your application online.',
    body: 'Applications for general admission and boarding for the 2027 academic year are now open. We welcome learners from Grade 8 to Grade 12. Please submit all required documents including a certified copy of the learner\'s birth certificate, progress report, and proof of residence. For boarding applications please also complete the HTL 02 and HTL 03 forms.',
    image: '',
    category: 'Admissions',
  },
  {
